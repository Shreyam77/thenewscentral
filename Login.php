...
<body>
	...
	<section class="ptb-0">
		...
		<div class="container">
			...
			<a class="color-ash mt-10" href="Login.php">Log In</a>
		</div><!-- container -->
	</section>
							...
							<div class="login-form">
								...
								<div class="input-box">
									<div class="single-input-fields">
										...
										<input name="uname" type="text" placeholder="Username / Email address">
									</div>
									<div class="single-input-fields">
								...
								<div class="login-footer">
									...
									<button name="login" type="submit" class="submit-btn3">Log In</button>
								</div>
								</form>
							</div>
						</div>
