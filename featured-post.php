...
<body>
	...
	<section class="ptb-0">
		...
		<div class="container">
			...
			<a class="mt-10 color-ash" href="featured-post.php">Featured Posts</a>
		</div><!-- container -->
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-8">
					...
					<div id="politics"></div>
					<?php
						$query = mysqli_query($connection,"Select * from featured WHERE category='politics' ");
						$row = mysqli_fetch_array($query);

						$query1 = mysqli_query($connection,"Select * from politics WHERE t='$row[title]'");
					...
					<div id="world"></div>
					<?php
						$query = mysqli_query($connection,"Select * from featured WHERE category='world' ");
						$row = mysqli_fetch_array($query);

						$query1 = mysqli_query($connection,"Select * from world WHERE t='$row[title]'");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
					...
					<?php
						$query = mysqli_query($connection,"Select * from featured WHERE category='technology' ");
						$row = mysqli_fetch_array($query);

						$query1 = mysqli_query($connection,"Select * from technology WHERE t='$row[title]'");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
					...
					<div id="health"></div>
					<?php
						$query = mysqli_query($connection,"Select * from featured WHERE category='health' ");
						$row = mysqli_fetch_array($query);

						$query1 = mysqli_query($connection,"Select * from health WHERE t='$row[title]'");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
					...
					<div id="travel"></div>
					<?php
						$query = mysqli_query($connection,"Select * from featured WHERE category='travel' ");
						$row = mysqli_fetch_array($query);

						$query1 = mysqli_query($connection,"Select * from travel WHERE t='$row[title]'");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
					...
					<div id="sports"></div>
					<?php
						$query = mysqli_query($connection,"Select * from featured WHERE category='sports' ");
						$row = mysqli_fetch_array($query);

						$query1 = mysqli_query($connection,"Select * from sports WHERE t='$row[title]'");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
				...
				<div class="col-md-6 col-lg-4">
					<div class="pl-20 pl-md-0">
						...
						<div class="mtb-50">
							<h4 class="p-title"><b>POPULAR NEWS</b></h4>
