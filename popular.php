...
<body>
	...
	<section class="ptb-0">
		...
		<div class="container">
			...
			<a class="mt-10 color-ash" href="#">Popular Posts</a>
		</div><!-- container -->
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-8">
					...
					<div id="health"></div>
					<?php
						$query1 = mysqli_query($connection,"Select * from health WHERE likes=(Select MAX(likes) from health)");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
					...
					<div id="travel"></div>
					<?php
						$query1 = mysqli_query($connection,"Select * from travel WHERE likes=(Select MAX(likes) from travel)");
						$row1 = mysqli_fetch_array($query1);
					?>
					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['i']);?>" alt="">
					<h3 class="mt-30"><b><?php echo $row1['t'];?></b></h3>
